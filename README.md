...
A Dockerfile to build [varnish/libvmod-header for varnish 4.1](https://github.com/varnish/libvmod-header/tree/4.1) rpm for CentOS7 using [copr](https://copr.fedoraproject.org/).
...
2. Put the spec file in the `SPECS` directory
3. Put the source files in the `SOURCES` directory
4. Edit variables and commands in `script/build.sh`
